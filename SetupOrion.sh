...
## --------------------------- ORION --------------------------- ##
  ...
  wppconnect${1:+_$1}_api:
    ...
    deploy:
      ...
      labels:
      - traefik.enable=1
      - traefik.http.routers.wppconnect${1:+_$1}_api.rule=Host(\`$url_wppconnect_api\`) && PathPrefix(\`/\`) ## Url do wppconnect API
...
Documentação: https://$url_wppconnect_front/api-docs
EOL
...
echo -e "\e[33mDocumentação: \e[97m https://$url_wppconnect_api/api-docs\e[0m"
